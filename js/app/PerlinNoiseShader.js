    ...
    class PerlinNoiseShader extends BaseShader {
        fillCode() {
            ...
            this.fragmentShaderCode = '#version 300 es\r\n' +
                ...
                'float value = perlinNoise(position,2000, 9, u_persistence,u_lacunarity, seed);\n' + // multiple octaves
        ...
        fillUniformsAttributes() {
            ...
            this.persistence = this.getUniform('u_persistence');
            this.lacunarity = this.getUniform('u_lacunarity');
        }
    }
